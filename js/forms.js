...
function storeValues(quoteForm)  
{
  setCookie("field1", quoteForm.fname.value);
  setCookie("field2", quoteForm.lname.value);
  setCookie("field3", quoteForm.field3.value);
  setCookie("field4", quoteForm.field4.value);
  return true;
}
